...
| GB/DEFRA (3개년) | 21,074 | **2,505** | 11.9% | 80+시트 병합셀/다중헤더 구조 파싱 한계, 시트당 추출률 저조 |
| NZ/MFE (3개년) | 5,590 | **1,807** | 32.3% | HTML 크롤링 위주, Excel 직접 다운로드 미활용 시트 존재 |
| JP/MOE | 3,814 | **925** | 24.3% | 전력 배출계수만 추출됨, 연료/프로세스/기타 카테고리 누락. IGES 403 차단 |
| US/EPA (2개년) | 3,542 | **457** | 12.9% | eGRID 3,173건 추출 성공했으나 DB 저장 단계에서 유실. 키 중복 덮어쓰기(thrashing) |
