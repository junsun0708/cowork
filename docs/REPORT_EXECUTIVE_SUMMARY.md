...
| 현재 실제 수집 | 384건 | 0.4% | US, JP 2개국만 성공 |

---

## 4. 현재 미지원 영역 및 개선 계획

### 4.1 즉시 개선 가능 (코드 수정 완료, 재수집 필요)

| 항목 | 예상 효과 | 상태 |
|------|-----------|------|
| GB/DEFRA xlsx 수집 | **+21,074건** (2023~2025 3개년) | fetch_auto 버그 수정 완료 |
| INTL 불필요 크롤링 제거 | 속도 2배 개선 | 코드 수정 완료 |
| DB 영구 저장 경로 | 데이터 소실 방지 | 경로 설정 완료 |
...
> GB/DEFRA 수집 성공 시 **한번에 21,000건+ 확보** 가능합니다.
>
